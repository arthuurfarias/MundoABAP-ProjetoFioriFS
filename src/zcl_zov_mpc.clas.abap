...
public section.
  ...
  types:
TT_OV_HEADER type standard table of TS_OV_HEADER .
  types:
  begin of TS_OV_ITEM,
     ORDEMID type I,
     ITEMID type I,
  ...
  types:
TT_OV_ITEM type standard table of TS_OV_ITEM .
  types:
  begin of TS_OV_MESSAGE,
     PK type I,
  ...
  end of TS_OV_MESSAGE .
  types:
TT_OV_MESSAGE type standard table of TS_OV_MESSAGE .

  constants GC_OV_HEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'OV_Header' ##NO_TEXT.
  constants GC_OV_ITEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'OV_Item' ##NO_TEXT.
  constants GC_OV_MESSAGE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'OV_Message' ##NO_TEXT.
  constants GC_ZCT_MESSAGE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZCT_MESSAGE' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_COMPLEXTYPES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_OV_HEADER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_OV_ITEM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_OV_MESSAGE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
lo_action->set_return_complex_type( 'ZCT_MESSAGE' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'OrdemID'    iv_abap_fieldname = 'ORDEMID' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_ZFI_UPDATE_STATUS' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'OV_Header' "#EC NOTEXT
                            iv_right_type       = 'OV_Item' "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HeaderItemSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'OV_HeaderSet'              "#EC NOTEXT
...
* Navigation Properties for entity - OV_Header
lo_entity_type = model->get_entity_type( iv_entity_name = 'OV_Header' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ToItem' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOITEM' "#EC NOTEXT
                                                              iv_association_name = 'HeaderItem' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
*   COMPLEX TYPE - ZCT_MESSAGE
***********************************************************************************************************************************
lo_complex_type = model->create_complex_type( 'ZCT_MESSAGE' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZOV_MPC=>ZCT_MESSAGE' ). "#EC NOTEXT
  endmethod.


  method DEFINE_OV_HEADER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'OV_Header' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OV_HEADER' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'OV_HeaderSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'OV_Item' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OV_ITEM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'OV_ItemSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'OV_Message' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OV_MESSAGE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'OV_MessageSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240704095633'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'OV_Message'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
